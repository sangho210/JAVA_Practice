...
--4. EMP 테이블에서 입사일이 2월, 20, 1981과 5월, 1, 1998 사이에 입사한 사원의 이름,업무,입사일을 출력하는 SELECT 문장을 작성하시오. 단 입사일 순으로 출력하시오.
...
--11. EMP 테이블에서 이름에 LL이 있고  부서가 30이거나 또는 관리자가 7782인 사원의 모든 정보를 출력하는 SELECT 문을 작성하여라.
